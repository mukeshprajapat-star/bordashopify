...
const Contactus = () => {
    ...
    const handlesubmit = () =>{
        window.open(`mailto:mukeshprajapat7529@gmail.com?subject=Sample&body=${body}`)
    }
    return (
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">8529674695</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn">MKstore@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
