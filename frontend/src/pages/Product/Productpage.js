        ...
        <div className = "img-display">
          ...
          <div className = "img-select">
            <div className = "img-item">
              <Link to = "#" data-id = "1">
                <Image  objectFit="cover" boxSize = '200px' src = {product.images[0]} alt = "show image"/>
            ...
            <div className = "img-item">
              <Link to = "#" data-id = "2">
                <Image  objectFit="cover" boxSize = '200px' src = {product.images[1]} alt = "show image"/>

              </Link>
            </div>
            <div className = "img-item">
              <Link to = "#" data-id = "3">
                <Image  objectFit="cover"  boxSize = '200px' src = {product.images[2]} alt = "show image"/>
